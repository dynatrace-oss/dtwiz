...
- [x] 2.3 Update OpenSpec deltas for `otel-host-monitoring`, `otel-extension-activation`, `otel-host-monitoring-grail-routes`, `otel-extension-deactivation`, and `otel-collector-update` to remove experimental flag requirements and any host-monitoring config toggle.
