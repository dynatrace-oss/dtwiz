...
- **Non-regression**: Existing `install otel` combined flow updated — Node.js is now enabled by default alongside Python. Existing `uninstall otel` collector cleanup unchanged — Node.js cleanup is additive.
